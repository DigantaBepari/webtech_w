...
<head>
    ...
    <title>AutoFix Admin Panel</title>
    <!-- Icons -->
...
<body>
    <nav class="navbar">
        <a href="#" class="brand" onclick="showSection('dashboard')">
            <i class="fas fa-wrench"></i> AutoFix
        </a>
    ...
    <main>
            ...
            <div class="table-container" style="margin-top: 15px;">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>2 hours ago</td>
                            <td>Inventory Update: Brake Pads</td>
        ...
        <section id="services" class="section-view">
            <header>
                ...
                <button class="btn btn-primary" onclick="openModal('service')"><i class="fas fa-plus"></i> Add Service</button>
            </header>
            <input type="text" placeholder="Search services..." class="search-bar" onkeyup="filterTable('services-table-body', this.value)">
        ...
        <section id="parts" class="section-view">
            <header>
                ...
                <button class="btn btn-primary" onclick="openModal('part')"><i class="fas fa-plus"></i> Add Part</button>
            </header>
            <input type="text" placeholder="Search parts..." class="search-bar" onkeyup="filterTable('parts-table-body', this.value)">
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
        ...
        <section id="users" class="section-view">
            <header>
                ...
                <button class="btn btn-primary" onclick="openModal('user')"><i class="fas fa-user-plus"></i> Add User</button>
            </header>
            <input type="text" placeholder="Search users..." class="search-bar" onkeyup="filterTable('users-table-body', this.value)">
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
        ...
        <div class="modal">
            ...
            <form id="dynamic-form" onsubmit="handleFormSubmit(event)">
                ...
                <div style="margin-top: 25px; text-align: right;">
                    <button type="button" class="btn" style="background: #f1f5f9; margin-right: 10px;" onclick="closeModal()">Cancel</button>
